...
class AnalyticUtilTests(unittest.TestCase):
    ...
    def test_compute_candle_stats(self):
        ...
        expected_columns : List[str] = [
            ...
            'macd', 'signal', 'macd_minus_signal', 'macd_cross', 'macd_bullish_cross_last_id', 'macd_bearish_cross_last_id', 'nums_intervals_since_last_cross', 'macd_cross_last', 'macd_segment_id',
