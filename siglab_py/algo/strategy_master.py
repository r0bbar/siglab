...
param : Dict = {
    ...
    "selected_fields_for_notification_attachment" : [ "gateway_id", "ticker", "pos_side", "pos_status", "pnl_live_bps", "max_unreal_live_bps", "sl_trailing_min_threshold_crossed",  "pos_created", "pos_tp_min_crossed", "mid", "entry_px", "tp_min_target", "tp_max_target", "sl_price" ],
