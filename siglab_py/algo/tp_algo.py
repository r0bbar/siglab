        ...
        "configurations": [
            {
                ...
                "args" : [
                        ...
                        "--default_effective_tp_trailing_percent", "100",
                        "--sl_percent", "1",
...
def parse_args():
    ...
    parser.add_argument("--default_effective_tp_trailing_percent", help="Default for sl_percent_trailing when pnl still below tp_min_percent.", default=None)
