        ...
        while (not position_break):
            try:
                ...
                position_summary : Dict[str, Union[str, int, float]] = {
                    ...
                    'sl_hard_percent' : float(sl_hard_percent),
                    'running_sl_percent_hard' : float(running_sl_percent_hard),
                    ...
                    'tp_max_target' : float(tp_max_target),
                    'tp_min_target' : float(tp_min_target),
                    'sl_price' : float(sl_price),
                    'max_pnl_potential_bps' : float(max_pnl_potential_bps),
                    'close_px' : float(close_px),
                    'unreal_live' : float(unreal_live),
                    'max_unreal_live' : float(max_unreal_live),
                    'max_pain' : float(max_pain),
                    'max_recovered_pnl' : float(max_recovered_pnl),
                    'pnl_live_bps' : float(pnl_live_bps),
                    'pnl_open_bps' : float(pnl_open_bps),
                    'max_unreal_live_bps' : float(max_unreal_live_bps),
                    'max_unreal_open_bps' : float(max_unreal_open_bps),
                    'max_pain_percent_notional' : float(max_pain_percent_notional),
                    'max_recovered_pnl_percent_notional' : float(max_recovered_pnl_percent_notional)
                }
