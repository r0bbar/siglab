...
The simplest example [**test_ordergateway.py**](https://github.com/r0bbar/siglab/blob/master/siglab_py/ordergateway/test_ordergateway.py) (Or a full example [**tp_algo.py**](https://github.com/r0bbar/siglab/blob/master/siglab_py/algo/tp_algo.py) or [**strategy_executor**](https://github.com/r0bbar/siglab/blob/master/siglab_py/algo/strategy_executor.py)) on what you need to implement strategy side to send orders, and wait for fills is:
